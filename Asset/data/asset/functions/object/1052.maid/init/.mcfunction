...
# 頭選択
    ...
    execute if score $Random Temporary matches 0 run data modify entity @s CustomName set value '{"text":"リィス"}'
    execute if score $Random Temporary matches 1 run item replace entity @s armor.head with stick{CustomModelData:20404} 1
    execute if score $Random Temporary matches 1 run data modify entity @s CustomName set value '{"text":"トリナ"}'
    execute if score $Random Temporary matches 2 run item replace entity @s armor.head with stick{CustomModelData:20405} 1
    execute if score $Random Temporary matches 2 run data modify entity @s CustomName set value '{"text":"アルギス"}'
    execute if score $Random Temporary matches 3 run item replace entity @s armor.head with stick{CustomModelData:20406} 1
    execute if score $Random Temporary matches 3 run data modify entity @s CustomName set value '{"text":"ティクリエ"}'
